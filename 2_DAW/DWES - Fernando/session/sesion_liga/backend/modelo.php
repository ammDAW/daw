...
{
	$sentencia = "select partido_id, a.equipo as local , b.equipo as visitante, marcador_local , marcador_visitante, estado, espectadores from liga_partidos, liga_equipos as a, liga_equipos as b where liga_partidos.local_id = a.equipo_id and liga_partidos.visitante_id = b.equipo_id and jornada_id = ? order by partido_id";
	$resultado  = $GLOBALS['DB']->prepare($sentencia);
	$resultado->bindParam( 1, $jornada );
	$resultado->execute();
